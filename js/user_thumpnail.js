(function ($) {
    ...
    var selectitem = function (element, options, e) {
        if (e) {
            e.stopPropagation();
            e.preventDefault();
        }
        ...
        this.val = selectitem.prototype.val;
        this.render = selectitem.prototype.render;
        this.refresh = selectitem.prototype.refresh;
        this.setStyle = selectitem.prototype.setStyle;
        this.selectAll = selectitem.prototype.selectAll;
        this.deselectAll = selectitem.prototype.deselectAll;
        this.destroy = selectitem.prototype.remove;
        this.remove = selectitem.prototype.remove;
        this.show = selectitem.prototype.show;
        this.hide = selectitem.prototype.hide;

        this.init();
    };

    selectitem.VERSION = "1.6.4";
    ...
    selectitem.prototype = {
            ...
            var generateLI = function (content, index, classes, optgroup) {
                return (
                    ...
                    ((typeof index !== "undefined") & (index !== null)
                        ...
                        : "") +
                    ((typeof optgroup !== "undefined") & (optgroup !== null)
            ...
            var generateA = function (
                ...
                return (
                    ...
                    (multiple
                        ...
                        ' check-mark" aria-hidden="true"></span>'
                        : "") +
                    "</a>"
                );
            };
            ...
            this.$element.find("option").each(function (index) {
                ...
                var optionClass = $this.attr("class") || "",
                    ...
                    subtext = $this.data("subtext")
                        ? '<small class="text-muted">' + $this.data("subtext") + "</small>"
                        : "",
                    icon = $this.data("icon")
                        ? '<span class="' +
                        $this.data("icon") +
                ...
                if ($this.data("thumbnail")) {
                    ...
                    text =
                        '<span class="media">' +
                        '<span class="media-left"><img src="' +
                        $this.data("thumbnail") +
                        '" class="media-object" onerror="src=\'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7\'"></span>' +
                ...
                if ($this.parent().is("optgroup") && $this.data("divider") !== true) {
                    if ($this.index() === 0) {
                        ...
                        var label = $this.parent().attr("label"),
                            labelSubtext = $this.parent().data("subtext")
        ...
        render: function (updateLi) {
            ...
            this.$button
                ...
                .html(
                    !this.multiple || this.options.selectedTextFormat === "values"
                        ? title
                        : this.options.title
                );
        ...
        setStyle: function (style, status) {
            if (this.$element.attr("class")) {
                this.$newElement.addClass(
                    this.$element
                        .attr("class")
                        .replace(/selectitem|mobile-device|validate\[.*\]/gi, "")
                );
            }
        ...
        liHeight: function () {
            ...
            var $selectClone = this.$menu
                ...
                actionsHeight = this.options.actionsBox
                    ...
                    : 0,
                doneButtonHeight = this.multiple
                    ? $menuClone.find(".bs-donebutton").outerHeight()
                    : 0;
        ...
        setSize: function () {
            ...
            if (this.options.size === "auto") {
                ...
                $menu.find("li").not(notDisabled).length > this.options.size
            ) {
                ...
                if ($this.is("select")) {
                    ...
                    if (!data) {
                        var config = $.extend(
                            {},
                            selectitem.DEFAULTS,
                            $.fn.selectitem.defaults || {},
                            $this.data(),
                            options
                        );
                        $this.data(
                            "selectitem",
                            (data = new selectitem(this, config, _event))
                        );
                    } else if (options) {
    ...
    var old = $.fn.selectitem;
    $.fn.selectitem = Plugin;
    $.fn.selectitem.Constructor = selectitem;

    // selectitem NO CONFLICT
    // ========================
    $.fn.selectitem.noConflict = function () {
        $.fn.selectitem = old;
        return this;
    };
    ...
    $(window).on("load.bs.select.data-api", function () {
        $(".selectitem").each(function () {
            var $selectitem = $(this);
            Plugin.call($selectitem, $selectitem.data());
        });
    });
})(jQuery);
