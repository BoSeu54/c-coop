...
class class_conn
{
	...
	public $db_password = "";
	public $db_database = "c_cooperation";
	...
	public function formula($log_entry_date, $id_name_company, $group_company, $no_document, $transaction, $user_create, $amount_money, $vat, $tax, $_comp, $transaction_in_of_id)
	{
