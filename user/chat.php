  ...
  <div class="right_col" role="main">
        ...
        <div class="column2">
          ...
          <ul id="myUL">
            ...
            if ($room_id == null) {
              ...
              $roomid = $res['user_room'];
              if ($roomid == null) {
                echo $cls_conn->goto_page(0, '../chat/chat_create_user.php');
              } else {
                echo $cls_conn->goto_page(0, "chat.php?rid='$roomid'");
              }
            }
    ...
    <script>
      function send_messages(id) {
        ...
        console.log(msg);
        window.location = "../chat/chat_send_message.php?id=" + id + "&m=" + msg + "&dir=0";
      }
    </script>
</body>
